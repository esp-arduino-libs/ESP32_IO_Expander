...
public:
    ...
    constexpr static bool I2C_ENABLE_INTERNAL_PULLUP_DEFAULT = true;

    using HostHandle   = i2c_master_bus_handle_t;
    using DeviceHandle = esp_io_expander_handle_t;

    struct HostPartialConfig {
        int sda_io_num = -1;
        int scl_io_num = -1;
        bool enable_internal_pullup = I2C_ENABLE_INTERNAL_PULLUP_DEFAULT;
    };
    ...
    struct Config {
        ...
        void dumpHostConfig() const;
        void dumpDeviceConfig() const;
    ...
    Base(int scl_io, int sda_io, uint8_t address)
        : config_{
            ...
            .host = HostPartialConfig{
                .sda_io_num = sda_io,
                .scl_io_num = scl_io,
                .enable_internal_pullup = I2C_ENABLE_INTERNAL_PULLUP_DEFAULT,
            },
            .device{
                .address = address,
            }
...
// *INDENT-ON*
     ...
     * @return Host handle
     */
    HostHandle getHostHandle() const
    {
        return host_handle_;
    }
...
private:
    ...
    HostHandle host_handle_ = nullptr;
    struct {
        int is_host_skip_init : 1;
    } flags_ = {};
};
